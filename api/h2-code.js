...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Usage: node h2-flash [host] [time] [rps] [thread] [proxyfile]`); process.exit();}
...
const RESTART_DELAY = 1000;
 ...
 console.clear();
    ...
    console.log(`--------------------------------------------`.gray);
    console.log(`Merhods By Down Stresser`.brightCyan);
